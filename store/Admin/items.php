    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Cargar Artículos </a>
                    </li>
                    <li class="active"><a href="items.php"> &nbsp; &nbsp; &nbsp; Gestión de artículos</a></li>
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Gestión de artículos</strong> </h3></center>
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<center> <img src="item_images/<?php echo $item_image; ?>" class="img img-rounded"  width="50" height="50" /></center>
				 ...
				 <a class="btn btn-info" href="edititem.php?edit_id=
                 <?php echo $row['item_id']; ?>" title="click for edit" onclick="return confirm('Are you sure edit this item?')">
                 <span class='glyphicon glyphicon-pencil'></span> Editar</a> 
				
                  <a class="btn btn-danger" href="?delete_id=
                  <?php echo $row['item_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this item?')">
