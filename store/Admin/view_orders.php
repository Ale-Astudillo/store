    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Detalles del pedido del cliente</strong> </h3></center>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='3' align='right' style='font-size:20px;'>Customer: ".$user_firstname." ".$user_lastname." | <span style='color:red'>Total Pagar:</span>";
		echo "</td>";
