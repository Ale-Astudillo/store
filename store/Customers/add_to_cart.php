...
<body>
	...
	?>
                ...
                <div class="alert alert-default" style="color:white;background-color:#008CBA">
                    <center>
                        <h3> <span class="glyphicon glyphicon-info-sign"></span> Detalle de Orden</h3>
                    </center>
                </div>
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        <td><label class="control-label">Nombre del artículo.</label></td>
                        <td><input class="form-control" type="text" name="v1" value="<?php echo $item_name; ?>"
                                disabled /></td>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text" name="v2" value="<?php echo $item_price; ?>"
                                disabled /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text" placeholder="Quantity" name="order_quantity"
                                value="1" onkeypress="return isNumber(event)" onpaste="return false" required />
                    ...
                    <tr>
                        <td colspan="2"><button type="submit" name="order_save" class="btn btn-primary">
                                <span class="glyphicon glyphicon-shopping-cart"></span> Aceptar
                            </button>

                            <a class="btn btn-danger" href="shop.php?id=1"> <span
