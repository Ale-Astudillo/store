...
<body>
    <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="orders.php"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span>
                            Mis Ordenes</a></li>
                    <li class="active"><a href="view_purchased.php"> &nbsp; <span class='glyphicon glyphicon-eye-open'></span> Ordenes Anteriores</a></li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="glyphicon glyphicon-eye-open"></span> Artículos anteriores pedidos</h3></center>
        </div>
