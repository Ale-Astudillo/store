...
<body>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total Pagar: 	&#x24; <?php echo $total; ?> </b></a>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/1.jpg" alt="..." style="width:100%;height:830px;">
        ...
        <div class="item">
            <img src="../assets/img/2.jpg" alt="..." style="width:100%;height:830px;">
        ...
        <div class="item">
            <img src="../assets/img/3.jpg" alt="..." style="width:100%;height:830px;">
		...
		<div class="item">
            <img src="../assets/img/4.jpg" alt="..." style="width:100%;height:830px;">
		...
		<div class="item">
            <img src="../assets/img/5.jpg" alt="..." style="width:100%;height:830px;">
