    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-default" style="color:white;background-color:#008CBA">
                <center>
                    <h3> <span class="glyphicon glyphicon-shopping-cart"></span> Catálogo de Articulos!</h3>
                </center>
            </div>
...
$query1=mysqli_connect("localhost","root","", "store");
...
while($query2=mysqli_fetch_array($query))
{
	...
	echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#gray;'>
            <div class='panel-heading' >
            <center> 
			<h4 style='text-align:center; class='form-control' rows='1' disabled>".$query2['item_name']."</h4>
			</center>
            </div>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<a class='btn btn-block btn-danger' href='add_to_cart.php?cart=".$query2['item_id']."'><span class='glyphicon glyphicon-shopping-cart'></span> Añadir a la cesta</a>
            </div>
          </div>
        </div>";
