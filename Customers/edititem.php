...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
                    <span class="sr-only">Página de Navegaciónn</span>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a data-toggle="modal" data-target="#uploadModal"> &nbsp; &nbsp; &nbsp; Actualizar artículos</a></li>
	...
	?>
                <div class="alert alert-info">
                    ...
                    <center>
                        <h3><strong>Actualizar artículo</strong> </h3>
                    </center>
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <p><img class="img img-thumbnail" src="item_images/<?php echo $item_image; ?>" height="150"
                                    width="150" /></p>
                    ...
                    <tr>
                        <td colspan="2"><button type="submit" name="btn_save_updates" class="btn btn-primary">
                            ...
                            <a class="btn btn-danger" href="items.php"> <span
