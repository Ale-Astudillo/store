...
<body>
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active"><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Carrito de compras</a>
                    </li>
                    <li ><a href="orders.php"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span>
                            Mis Ordenes</a></li>
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total Pagar: 	&#x24;
                         <?php echo $total; ?> </b></a>
                     ...
                     <li class="dropdown user-dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a data-toggle="modal" data-target="#setAccount"><i class="fa fa-gear"></i> Configuración</a></li>
                            <li class="divider"></li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="fa fa-cart-plus"></span> Carrito de Compras</h3></center>
        </div>
			...
			?>
                <tr>
				 ...
				 <td>
                  ...
                  <a class="btn btn-block btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this item?')"><span class='glyphicon glyphicon-trash'></span> Quitar Artículo</a>
